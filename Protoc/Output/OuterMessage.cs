...
namespace Secode.Network {
  ...
  public partial class Actor_CreateUnits : pb::IMessage {
    ...
    private static readonly pb::FieldCodec<global::Secode.Network.UnitInfo> _repeated_units_codec
        = pb::FieldCodec.ForMessage(10, global::Secode.Network.UnitInfo.Parser);
    private pbc::RepeatedField<global::Secode.Network.UnitInfo> units_ = new pbc::RepeatedField<global::Secode.Network.UnitInfo>();
    public pbc::RepeatedField<global::Secode.Network.UnitInfo> Units {
      get { return units_; }
      set { units_ = value; }
    }
